...
export class ContactListComponent extends ListBaseComponent implements OnInit, OnChanges, AfterViewInit, DoCheck {
  ...
  constructor(private _fb: FormBuilder, private translate: TranslateService, private _routingService: RoutingService, private _utilService: UtilsService,
    ...
    this._loggerService.log("contact.list", "constructor", "");
  }

  ngOnInit() {
    this._loggerService.log("contact.list", "ngOnInit", "");
    // console.log('this.isInterannnnnl: ' + this.isInternal);
  }

  ngAfterViewInit() {
    this._loggerService.log("contact.list", "ngAfterViewInit", "");
  ...
  ngDoCheck() {
    this._loggerService.log("contact.list", "ngDoCheck", "");
    this.isValid();
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes['contactModel']) {
      ...
      // this.dataModel = this.service.getModelRecordList();
      this.dataModel = changes['contactModel'].currentValue;
  ...
  public addContact(): void {
    ...
    const stateData = {
      navLanguageList: this.languageList,
      navStatusList: this.contactStatusList,
    };

    this._routingService.navigateToWithExtra(this.contactRoutePath, stateData);
